...
public class FastBlur {
    ...
    public void callBlur(final View targetView, final View pasteView, final OnBlurCompleteInterface onBlurCompleteInterface) {
        ...
        targetView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                if (Integer.valueOf(Build.VERSION.SDK_INT) >= 16) {
                    ...
                    pasteView.setBackground(new BitmapDrawable(pasteView.getResources(), prepareAndSetBitmap(targetView)));
                } else {
                    targetView.getViewTreeObserver().removeGlobalOnLayoutListener(this);
                    pasteView.setBackgroundDrawable(new BitmapDrawable(pasteView.getResources(), prepareAndSetBitmap(targetView)));
                }

                onBlurCompleteInterface.onBlurComplete();
            }
        });
    }
